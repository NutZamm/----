        ...
        Callback = function(value)
            ...
            if _G.Start_Tween_Island == true then
                repeat wait()
                    ...
                    elseif _G.Select_Island == "Hot & cold" then
                        ByPass(CFrame.new(-5853.087890625, 2.347776174545288, -5121.84521484375))
                    ...
                    elseif _G.Select_Island == "Castle On The Sea" then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-5072.08056640625, 314.5412902832031, -3145.187255859375))
                    ...
                    elseif _G.Select_Island == "Hydra Island" then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(5750.427734375, 610.4498291015625, -269.56414794921875))
                    ...
                    elseif _G.Select_Island == "CandyCane" then
                        ByPass(CFrame.new(-1055.772705078125, 8.483050346374512, -14027.6396484375))
                    elseif _G.Select_Island == "CandyCaneW2" then
                        ByPass(CFrame.new(-5153.30126953125, 7.0112996101379395, 1535.99169921875))
                    elseif _G.Select_Island == "CandyCaneW1" then
                        ByPass(CFrame.new(335.29132080078125, 4.2089033126831055, -2117.778564453125))
                    end
